...
class InvertedIndex:
    ...
    def save(self) -> None:
        save_cache(self.index, self.index_path)
        save_cache(self.docmap, self.docmap_path)
        save_cache(self.term_frequencies, self.tf_path)
        save_cache(self.doc_lengths, self.doc_lengths_path)

    def load(self) -> None:
        self.index = load_cache(self.index_path)
        self.docmap = load_cache(self.docmap_path)
        self.term_frequencies = load_cache(self.tf_path)
        self.doc_lengths = load_cache(self.doc_lengths_path)
